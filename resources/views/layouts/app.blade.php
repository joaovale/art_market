    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/enderecos') }}">
                    {{ config('app.obras', 'Endreço') }}
                </a>

                <a class="navbar-brand" href="{{ url('/telefones') }}">
                    {{ config('app.obras', 'Telefone') }}
                </a>
                ...
                <a class="navbar-brand" href="{{ url('/pagamentos') }}">
                    {{ config('app.obras', 'Pagamentos') }}
                </a>
        ...
        <div class="  collapse navbar-collapse ml-4" id="navbarNavDropdown">
          <ul class=" navbar-nav ml-5">
            ...
            <li class="nav-item dropdown ">
                <a class="nav-dark " href="{{ url ('obras/'.'1'.'/select')}}" >
                Pinturas
                </a>
                <!-- <div class="dropdown-menu btn-warning mt-4">
                  <a class="dropdown-item" href="{{ url ('obras/{obra}/select')}}">TODOS</a>
            ...
            <li class="nav-item dropdown ">
            <li class="nav-item dropdown ">
                <a class="nav-dark " href="{{ url ('obras/'.'2'.'/select')}}" >
                Fotografias
              </a>
              <!-- <div class="dropdown-menu btn-warning mt-4">
